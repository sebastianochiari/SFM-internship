...
Group_Data_X = zeros(0,0);
Group_Data_Y = zeros(0,0);
Group_Score_X = zeros(0,0);
Group_Score_Y = zeros(0,0);
...
[thetaX2, J_history2] = gradientDescentMulti(Group_input,Group_output,thetaX2,alpha,num_iters);
