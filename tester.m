...
%% Adding crowdness
disp('Adding crowdness/smooth-crowdedness');

tic

crowdedness = 0;
smooth_crowdedness = 1;
...
for i = 1:size(new_data,2)
    ...
    elseif smooth_crowdedness == 1
        Subject_Data(i,7) = new_data(9,i);
        Subject_Data(i,8) = new_data(10,i);
        Subject_Data(i,9) = new_data(11,i);
    end
    ...
    elseif smooth_crowdedness == 1
        Subject_Score(2,i) = new_data(9,i); 
        Subject_Score(3,i) = new_data(10,i);
        Subject_Score(4,i) = new_data(11,i);
    end
